...
def add_standard(node, seq_list):
    slice_low_class=[ "나박하게", "길게", "얇게", "깍둑", "채를", "먹기좋은 크기로", "먹기 좋은 두께로", "도톰하게", "격자로", "잘게", "세로로", "가로로", "편으로", "도톰한 두께로", "링으로", "반으로", "채", "한입 크기로", "큼직하게", "동그란 모양으로", "굵게", "적당한 길이로", "반달모양으로", "나무젓가락 두께로","곱게","마름모 모양으로", "길죽한 모양으로","반을", "등분으로","어슷","가늘게", "한마디 크기", "주사위 모양으로", "반 정도만", "길이 방향으로", "결 따라","바둑판 모양으로", "큼지막하게","비스듬하게","깍뚝", "편", "같은 크기로"]
    useFire_low_class=["퍼질때까지","자작하게","농도가 적당해질 때까지","한번 더","뭉근하게", "약간의 기포가 올라올 때까지","물기가 날아갈 정도로", "가볍게", "재빨리","바삭하게","겉만 살짝","튀기듯이","빠르게","투명해 질때까지", "부드러워질 때까지", "숨이 죽을 때까지","졸이듯이","브라운 색이 나도록","물기가 없어질 때까지", "되직하게","수분이 없게", "앞뒤로","뒤집어가며", "겉면이 타듯이", "뒤집어서", "앞 뒤로", "바삭하게", "양면을", "동그랗게", "돌려가며", "튀기듯이", "국물이 자작해 질 떄까지", "물기가 없어질 때까지","윤기나게","끈적한 농도가 날 때 까지","뒤집어가며", "숨이 죽을 정도로", "양이 반으로 줄어들 때까지","반쯤", "속까지", "투명하게", "뒤집어","은근히","겉만","한쪽면만","진한 갈색이 날 때까지","윤기나게","부드럽게","익을 때까지","굴려가며","노릇노릇하게","반숙으로","반숙상태로", "팥이 무르도록","노릇하게", "얇게","두툼하게"]
