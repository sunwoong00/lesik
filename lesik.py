...
def add_standard(node, seq_list):
    slice_low_class=[ "나박하게", "길게", "얇게", "깍둑", "채를", "먹기좋은 크기로", "먹기 좋은 두께로", "도톰하게", "격자로", "잘게", "세로로", "가로로", "편으로", "도톰한 두께로", "링으로", "반으로", "채", "한입 크기로", "큼직하게", "동그란 모양으로", "굵게", "적당한 길이로", "반달모양으로", "나무젓가락 두께로","곱게","마름모 모양으로", "길죽한 모양으로","반을", "등분으로","어슷","가늘게", "한마디 크기", "주사위 모양으로", "반 정도만", "길이 방향으로", "결 따라","가늘게","바둑판 모양으로","한마디 크기로", "큼지막하게","비스듬하게","깍뚝", "편", "같은 크기로"]
