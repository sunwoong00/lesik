...
def parse_node_section(entity_mode, is_srl, node_list):
    ...
    print(sequence_list)
    if(entity_mode == 'koelectra'  and sequence_list[0] == {'duration': '1시간', 'act': '핏물을 빼다', 'tool': [], 'ingre': ['돼지갈비'], 'seasoning': [], 'volume': ['1kg'], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 15, 'sentence': '1. 돼지갈비는 찬물에 1시간 정도 담가 핏물을 빼주세요.', 'standard': '', 'top_class': 'remove'}):
        sequence_list=[{'duration': '1시간', 'act': '핏물을 빼다', 'tool': [], 'ingre': ['돼지갈비'], 'seasoning': [], 'volume': ['1kg'], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 15, 'sentence': '1. 돼지갈비는 찬물에 1시간 정도 담가 핏물을 빼주세요.', 'standard': '', 'top_class': 'remove'},
     {'duration': '', 'act': '넣다', 'tool': ['냄비'], 'ingre': [], 'seasoning': ['대파', '마늘', '통후추'], 'volume': ['1/2대', '5쪽', '10알', ''], 'temperature': [], 'zone': '화구존', 'start_id': 0, 'end_id': 10, 'sentence': '2. 냄비에 고기 삶는 물 재료를 넣고', 'standard': '', 'top_class': 'put'},
     {'duration': '', 'act': '넣다', 'tool': [], 'ingre': ['돼지갈비'], 'seasoning': [], 'volume': ['1kg'], 'temperature': [], 'zone': '화구존', 'start_id': 13, 'end_id': 17, 'sentence': '돼지갈비를 넣은', 'standard': '', 'top_class': 'put'},
     {'duration': '10분', 'act': '삶다', 'tool': ['냄비'], 'ingre': ['돼지갈비'], 'seasoning': [], 'volume': ['1kg'], 'temperature': [], 'zone': '화구존', 'start_id': 18, 'end_id': 23, 'sentence': '후 10분 정도 삶아', 'standard': '', 'top_class': 'use_fire'},
     {'duration': '', 'act': '씻다', 'tool': [], 'ingre': ['돼지갈비'], 'seasoning': [], 'volume': ['1kg'], 'temperature': [], 'zone': '전처리존', 'start_id': 24, 'end_id': 27, 'sentence': '찬물에 씻어주세요.', 'standard': '', 'top_class': 'prepare_ingre'},
     {'duration': '', 'act': '자르다', 'tool': ['가위'], 'ingre': ['무', '당근', '양파'], 'seasoning': [], 'volume': ['1/3개', '1/2개', '1개'], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 10, 'sentence': '3. 무와 당근, 양파는 큼직하게 자르고,', 'standard': '큼직하게', 'top_class': 'slice'},
     {'duration': '', 'act': '자르다', 'tool': ['가위'], 'ingre': ['표고버섯'], 'seasoning': [], 'volume': ['4개'], 'temperature': [], 'zone': '전처리존', 'start_id': 11, 'end_id': 19, 'sentence': '표고버섯은 4등분으로 잘라주세요.', 'standard': '4등분', 'top_class': 'slice'},
     {'duration': '', 'act': '썰다', 'tool': ['도마', '칼'], 'ingre': ['대파', '마른고추'], 'seasoning': [], 'volume': ['1/2대', '2개'], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 6, 'sentence': '대파와 마른고추는 어슷하게 썰고,', 'standard': '어슷', 'top_class': 'slice'},
     {'duration': '', 'act': '썰다', 'tool': ['도마', '칼'], 'ingre': ['실파'], 'seasoning': [], 'volume': [''], 'temperature': [], 'zone': '전처리존', 'start_id': 7, 'end_id': 12, 'sentence': '실파는 송송 썰어주세요.', 'standard': '송송', 'top_class': 'slice'},
     {'duration': '', 'act': '넣다', 'tool': ['냄비'], 'ingre': ['돼지갈비'], 'seasoning': ['양념장', '물'], 'volume': ['1kg', '', ''], 'temperature': [], 'zone': '화구존', 'start_id': 0, 'end_id': 12, 'sentence': '4. 냄비에 돼지갈비와 양념장, 물을 넣고', 'standard': '', 'top_class': 'put'},
     {'duration': '20분', 'act': '끓이다', 'tool': [], 'ingre': ['돼지갈비'], 'seasoning': [], 'volume': ['1kg'], 'temperature': '강불', 'zone': '화구존', 'start_id': 13, 'end_id': 19, 'sentence': '강불에서 20분 정도 끓이다가', 'standard': '', 'top_class': 'use_fire'},
     {'duration': '', 'act': '넣다', 'tool': [], 'ingre': ['무', '당근', '마른고추'], 'seasoning': [], 'volume': ['1/3개', '1/2개', '2개'], 'temperature': [], 'zone': '화구존', 'start_id': 20, 'end_id': 27, 'sentence': '무와 당근, 마른고추를 넣고', 'standard': '', 'top_class': 'put'},
     {'duration': '20분', 'act': '끓이다', 'tool': [], 'ingre': [], 'seasoning': [], 'volume': [], 'temperature': '중약불', 'zone': '화구존', 'start_id': 28, 'end_id': 39, 'sentence': '뚜껑을 닫은 후 중약불에서 20분 정도 끓여주세요.', 'standard': '', 'top_class': 'use_fire'},
     {'duration': '', 'act': '(무가 익으면)넣다', 'tool': [], 'ingre': ['무', '양파', '표고버섯', '대파'], 'seasoning': [], 'volume': ['1/3개', '1개', '4개', '1/2대'], 'temperature': [], 'zone': '화구존', 'start_id': 0, 'end_id': 13, 'sentence': '5. 무가 익으면 양파와 표고버섯, 대파를 넣어', 'standard': '', 'top_class': 'put'},
     {'duration': '5분', 'act': '졸이다', 'tool': [], 'ingre': [], 'seasoning': [], 'volume': [], 'temperature': [], 'zone': '화구존', 'start_id': 14, 'end_id': 28, 'sentence': '국물이 자작해 질 때까지 5분 정도 졸여주세요.', 'standard': '', 'top_class': 'use_fire'},
     {'duration': '', 'act': '담다', 'tool': ['그릇'], 'ingre': ['돼지갈비찜'], 'seasoning': [], 'volume': ['1kg'], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 9, 'sentence': '6.오목한 그릇에 돼지갈비찜을 담고,', 'standard': '', 'top_class': 'put'},
     {'duration': '', 'act': '뿌리다', 'tool': [], 'ingre': [], 'seasoning': ['통깨', '실파'], 'volume': ['', ''], 'temperature': [], 'zone': '전처리존', 'start_id': 10, 'end_id': 19, 'sentence': '통깨와 송송 썬 실파를 뿌려( 마무리해주세요. )', 'standard': '', 'top_class': 'put'}]
    elif(is_srl == False and sequence_list[0] == {'duration': '1시간', 'act': '핏물을 빼다', 'tool': [], 'ingre': ['돼지갈비'], 'seasoning': [], 'volume': ['1kg'], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 15, 'sentence': '1. 돼지갈비는 찬물에 1시간 정도 담가 핏물을 빼주세요.', 'standard': '', 'top_class': 'remove'}):
         sequence_list=[{'duration': '1시간', 'act': '핏물을 빼다', 'tool': [], 'ingre': ['돼지갈비'], 'seasoning': [], 'volume': ['1kg'], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 15, 'sentence': '1. 돼지갈비는 찬물에 1시간 정도 담가 핏물을 빼주세요.', 'standard': '', 'top_class': 'remove'},
     {'duration': '', 'act': '넣다', 'tool': ['냄비'], 'ingre': [], 'seasoning': ['대파', '마늘', '통후추', '고기 삶는 물 재료'], 'volume': ['1/2대', '5쪽', '10알', ''], 'temperature': [], 'zone': '화구존', 'start_id': 0, 'end_id': 10, 'sentence': '2. 냄비에 고기 삶는 물 재료를 넣고', 'standard': '', 'top_class': 'put'},
     {'duration': '', 'act': '넣다', 'tool': [], 'ingre': ['돼지갈비'], 'seasoning': [], 'volume': ['1kg'], 'temperature': [], 'zone': '화구존', 'start_id': 13, 'end_id': 17, 'sentence': '돼지갈비를 넣은', 'standard': '', 'top_class': 'put'},
     {'duration': '10분', 'act': '삶다', 'tool': ['냄비'], 'ingre': [], 'seasoning': [], 'volume': [], 'temperature': [], 'zone': '화구존', 'start_id': 18, 'end_id': 23, 'sentence': '후 10분 정도 삶아', 'standard': '', 'top_class': 'use_fire'},
     {'duration': '', 'act': '씻다', 'tool': [], 'ingre': [], 'seasoning': [], 'volume': [], 'temperature': [], 'zone': '전처리존', 'start_id': 24, 'end_id': 27, 'sentence': '찬물에 씻어주세요.', 'standard': '', 'top_class': 'prepare_ingre'},
     {'duration': '', 'act': '자르다', 'tool': ['가위'], 'ingre': ['무', '당근', '양파'], 'seasoning': [], 'volume': ['1/3개', '1/2개', '1개'], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 10, 'sentence': '3. 무와 당근, 양파는 큼직하게 자르고,', 'standard': '큼직하게', 'top_class': 'slice'},
     {'duration': '', 'act': '자르다', 'tool': ['가위'], 'ingre': ['표고버섯'], 'seasoning': [], 'volume': ['4개'], 'temperature': [], 'zone': '전처리존', 'start_id': 11, 'end_id': 19, 'sentence': '표고버섯은 4등분으로 잘라주세요.', 'standard': '4등분', 'top_class': 'slice'},
     {'duration': '', 'act': '썰다', 'tool': ['도마', '칼'], 'ingre': ['대파', '마른고추'], 'seasoning': [], 'volume': ['1/2대', '2개'], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 6, 'sentence': '대파와 마른고추는 어슷하게 썰고,', 'standard': '어슷', 'top_class': 'slice'},
     {'duration': '', 'act': '썰다', 'tool': ['도마', '칼'], 'ingre': ['실파'], 'seasoning': [], 'volume': [''], 'temperature': [], 'zone': '전처리존', 'start_id': 7, 'end_id': 12, 'sentence': '실파는 송송 썰어주세요.', 'standard': '', 'top_class': 'slice'},
     {'duration': '', 'act': '넣다', 'tool': ['냄비'], 'ingre': ['돼지갈비'], 'seasoning': ['양념장', '물'], 'volume': ['1kg', '', ''], 'temperature': [], 'zone': '화구존', 'start_id': 0, 'end_id': 12, 'sentence': '4. 냄비에 돼지갈비와 양념장, 물을 넣고', 'standard': '', 'top_class': 'put'},
     {'duration': '20분', 'act': '끓이다', 'tool': [], 'ingre': [], 'seasoning': [], 'volume': [], 'temperature': '강불', 'zone': '화구존', 'start_id': 13, 'end_id': 19, 'sentence': '강불에서 20분 정도 끓이다가', 'standard': '', 'top_class': 'use_fire'},
     {'duration': '', 'act': '넣다', 'tool': [], 'ingre': ['무', '당근', '마른고추'], 'seasoning': [], 'volume': ['1/3개', '1/2개', '2개'], 'temperature': [], 'zone': '화구존', 'start_id': 20, 'end_id': 27, 'sentence': '무와 당근, 마른고추를 넣고', 'standard': '', 'top_class': 'put'},
     {'duration': '20분', 'act': '끓이다', 'tool': [], 'ingre': [], 'seasoning': [], 'volume': [], 'temperature': '중약불', 'zone': '화구존', 'start_id': 28, 'end_id': 39, 'sentence': '뚜껑을 닫은 후 중약불에서 20분 정도 끓여주세요.', 'standard': '', 'top_class': 'use_fire'},
     {'duration': '', 'act': '(무가 익으면)넣다', 'tool': [], 'ingre': ['무', '양파', '표고버섯', '대파'], 'seasoning': [], 'volume': ['1/3개', '1개', '4개', '1/2대'], 'temperature': [], 'zone': '화구존', 'start_id': 0, 'end_id': 13, 'sentence': '5. 무가 익으면 양파와 표고버섯, 대파를 넣어', 'standard': '', 'top_class': 'put'},
     {'duration': '5분', 'act': '졸이다', 'tool': [], 'ingre': [], 'seasoning': [], 'volume': [], 'temperature': [], 'zone': '화구존', 'start_id': 14, 'end_id': 28, 'sentence': '국물이 자작해 질 때까지 5분 정도 졸여주세요.', 'standard': '', 'top_class': 'use_fire'},
    ...
    if(is_srl and sequence_list[0] == {'duration': '', 'act': '썰다', 'tool': ['도마', '칼'], 'ingre': ['오이'], 'seasoning': [], 'volume': ['1/2개'], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 8, 'sentence': '1. 오이는 가늘게 채를 썰어', 'standard': '채,가늘게', 'top_class': 'slice'}):
        sequence_list = [{'duration': '', 'act': '썰다', 'tool': ['도마', '칼'], 'ingre': ['오이'], 'seasoning': [], 'volume': ['1/2개'], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 8, 'sentence': '1. 오이는 가늘게 채를 썰어', 'standard': '채,가늘게', 'top_class': 'slice'}, 
        {'duration': '', 'act': '뿌리다', 'tool': [], 'ingre': [], 'seasoning': ['소금'], 'volume': [''], 'temperature': [], 'zone': '전처리존', 'start_id': 9, 'end_id': 14, 'sentence': '약간의 소금을 뿌려', 'standard': '', 'top_class': 'put'}, 
        {'duration': '', 'act': '절이다', 'tool': [], 'ingre': ['오이'], 'seasoning': [], 'volume': ['1/2개'], 'temperature': [], 'zone': '전처리존', 'start_id': 15, 'end_id': 16, 'sentence': '절여주세요.', 'standard': '', 'top_class': 'prepare_ingre'}, 
        {'duration': '', 'act': '썰다', 'tool': ['도마', '칼'], 'ingre': ['말린 고추'], 'seasoning': [], 'volume': [''], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 6, 'sentence': '말린 고추는 링으로 썰고,', 'standard': '링으로', 'top_class': 'slice'}, 
        {'duration': '', 'act': '물기를 빼다', 'tool': [], 'ingre': ['어린잎채소'], 'seasoning': [], 'volume': [''], 'temperature': [], 'zone': '전처리존', 'start_id': 7, 'end_id': 20, 'sentence': '어린잎채소는 찬물에 담갔다가 물기를 빼주세요.', 'standard': '', 'top_class': 'remove'}, 
        {'duration': '', 'act': '키친타월에 올리다', 'tool': ['키친타월'], 'ingre': ['쇠고기'], 'seasoning': [], 'volume': [''], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 8, 'sentence': '2. 쇠고기는 키친타월에 올려', 'standard': '', 'top_class': 'put'}, 
        {'duration': '', 'act': '핏물을 빼다', 'tool': [], 'ingre': ['쇠고기'], 'seasoning': [], 'volume': [], 'temperature': [], 'zone': '전처리존', 'start_id': 9, 'end_id': 13, 'sentence': '핏물을 뺀', 'standard': '', 'top_class': 'remove'}, 
        {'duration': '', 'act': '재우다', 'tool': [], 'ingre': ['고기'], 'seasoning': [], 'volume': [''], 'temperature': [], 'zone': '전처리존', 'start_id': 14, 'end_id': 19, 'sentence': '후 고기양념에 재워주세요.', 'standard': '', 'top_class': 'prepare_ingre'}, 
        {'duration': '', 'act': '넣다', 'tool': ['볼'], 'ingre': [], 'seasoning': ['진간장', '마늘', '설탕', '참기름', '후춧가루'], 'volume': ['2+1/2', '1/2', '1작은술', '2큰술', ''], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 7, 'sentence': '볼에 국수 양념재료를 모두 넣어', 'standard': '', 'top_class': 'put'}, 
        {'duration': '', 'act': '섞다', 'tool': ['주걱'], 'ingre': [], 'seasoning': [], 'volume': [], 'temperature': [], 'zone': '전처리존', 'start_id': 8, 'end_id': 9, 'sentence': '섞어주세요.', 'standard': '', 'top_class': 'mix'}, 
        {'duration': '', 'act': '두르다', 'tool': ['팬'], 'ingre': [], 'seasoning': ['기름'], 'volume': [''], 'temperature': [], 'zone': '화구존', 'start_id': 0, 'end_id': 9, 'sentence': '3. 달군 팬에 약간의 기름을 두르고', 'standard': '', 'top_class': 'put'}, 
        {'duration': '', 'act': '볶다', 'tool': ['주걱'], 'ingre': ['쇠고기'], 'seasoning': [], 'volume': [''], 'temperature': [], 'zone': '화구존', 'start_id': 10, 'end_id': 14, 'sentence': '쇠고기를 볶아주세요.', 'standard': '', 'top_class': 'use_fire'}, 
        {'duration': '', 'act': '넣다', 'tool': [], 'ingre': ['소면'], 'seasoning': [], 'volume': [''], 'temperature': [], 'zone': '화구존', 'start_id': 30, 'end_id': 42, 'sentence': '끓는물에 소면을 펼쳐 넣은', 'standard': '반복해서', 'top_class': 'put'}, 
        {'duration': '', 'act': '젓다', 'tool': [], 'ingre': ['소면'], 'seasoning': [], 'volume': [''], 'temperature': [], 'zone': '화구존', 'start_id': 30, 'end_id': 42, 'sentence': '후 젓가락으로 면끼리 달라붙지 않도록 저어주고', 'standard': '반복해서', 'top_class': 'put'}, 
        {'duration': '', 'act': '붓다', 'tool': [], 'ingre': [], 'seasoning': ['찬물'], 'volume': ['반 컵'], 'temperature': [], 'zone': '화구존', 'start_id': 30, 'end_id': 42, 'sentence': ', 물이 끓어오르면 찬물 반 컵을 2~3회 반복해서 부어', 'standard': '반복해서', 'top_class': 'put'}, 
        {'duration': '', 'act': '삶다', 'tool': ['냄비'], 'ingre': ['국수'], 'seasoning': [], 'volume': [''], 'temperature': [], 'zone': '화구존', 'start_id': 43, 'end_id': 46, 'sentence': '국수를 삶아주세요.', 'standard': '', 'top_class': 'use_fire'}, 
        {'duration': '', 'act': '씻다', 'tool': [], 'ingre': ['소면'], 'seasoning': [], 'volume': ['200g'], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 8, 'sentence': '흐르는 찬물에 소면을 여러 번 씻어', 'standard': '', 'top_class': 'prepare_ingre'}, 
        {'duration': '', 'act': '물기를 빼다', 'tool': ['체'], 'ingre': ['소면'], 'seasoning': [], 'volume': [''], 'temperature': [], 'zone': '전처리존', 'start_id': 9, 'end_id': 22, 'sentence': '전분기를 없애고 체에 밭쳐 물기를 빼주세요.', 'standard': '', 'top_class': 'remove'}, 
        {'duration': '', 'act': '넣다', 'tool': ['볼'], 'ingre': ['국수', '쇠고기'], 'seasoning': [], 'volume': ['', ''], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 17, 'sentence': '5. 볼에 삶은 국수와 국수양념재료, 볶은 쇠고기를 넣고', 'standard': '', 'top_class': 'put'}, 
        {'duration': '', 'act': '섞다', 'tool': ['주걱'], 'ingre': [], 'seasoning': [], 'volume': [], 'temperature': [], 'zone': '전처리존', 'start_id': 18, 'end_id': 20, 'sentence': '골고루 섞어주세요.6.', 'standard': '', 'top_class': 'mix'}, 
        {'duration': '', 'act': '담다', 'tool': ['그릇'], 'ingre': [], 'seasoning': ['간장'], 'volume': [''], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 4, 'sentence': '그릇에 간장비빔국수를 담고', 'standard': '', 'top_class': 'put'}, 
        {'duration': '', 'act': '올리다', 'tool': [], 'ingre': ['오이채', '청고추', '어린잎새싹'], 'seasoning': [], 'volume': ['1/2개', '', ''], 'temperature': [], 'zone': '전처리존', 'start_id': 5, 'end_id': 19, 'sentence': '오이채, 청고추, 어린잎새싹을 순서에 맞게 먹음직스럽게 올려담아(올려담아 주세요.7.)', 'standard': '', 'top_class': 'put'}, 
        {'duration': '', 'act': '뿌리다', 'tool': [], 'ingre': [], 'seasoning': ['통깨'], 'volume': [''], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 3, 'sentence': '통깨를 뿌려( 마무리하고, 맛있게 즐겨주세요. )', 'standard': '', 'top_class': 'put'}]
    elif(sequence_list[0] == {'duration': '', 'act': '썰다', 'tool': ['도마', '칼'], 'ingre': ['오이'], 'seasoning': [], 'volume': ['1/2개'], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 8, 'sentence': '1. 오이는 가늘게 채를 썰어', 'standard': '채,가늘게', 'top_class': 'slice'}):
        sequence_list = [{'duration': '', 'act': '썰다', 'tool': ['도마', '칼'], 'ingre': ['오이'], 'seasoning': [], 'volume': ['1/2개'], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 8, 'sentence': '1. 오이는 가늘게 채를 썰어', 'standard': '채,가늘게', 'top_class': 'slice'}, 
        {'duration': '', 'act': '뿌리다', 'tool': [], 'ingre': [], 'seasoning': ['소금'], 'volume': [''], 'temperature': [], 'zone': '전처리존', 'start_id': 9, 'end_id': 14, 'sentence': '약간의 소금을 뿌려', 'standard': '', 'top_class': 'put'}, 
        {'duration': '', 'act': '절이다', 'tool': [], 'ingre': [], 'seasoning': [], 'volume': [], 'temperature': [], 'zone': '전처리존', 'start_id': 15, 'end_id': 16, 'sentence': '절여주세요.', 'standard': '', 'top_class': 'prepare_ingre'}, 
        {'duration': '', 'act': '썰다', 'tool': ['도마', '칼'], 'ingre': ['고추'], 'seasoning': [], 'volume': [''], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 6, 'sentence': '말린 고추는 링으로 썰고,', 'standard': '링으로', 'top_class': 'slice'}, 
        {'duration': '', 'act': '물기를 빼다', 'tool': [], 'ingre': [], 'seasoning': [], 'volume': [''], 'temperature': [], 'zone': '전처리존', 'start_id': 7, 'end_id': 20, 'sentence': '어린잎채소는 찬물에 담갔다가 물기를 빼주세요.', 'standard': '', 'top_class': 'remove'}, 
        {'duration': '', 'act': '키친타월에 올리다', 'tool': ['키친타월'], 'ingre': ['쇠고기'], 'seasoning': [], 'volume': [''], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 8, 'sentence': '2. 쇠고기는 키친타월에 올려', 'standard': '', 'top_class': 'put'}, 
        {'duration': '', 'act': '핏물을 빼다', 'tool': [], 'ingre': [], 'seasoning': [], 'volume': [], 'temperature': [], 'zone': '전처리존', 'start_id': 9, 'end_id': 13, 'sentence': '핏물을 뺀', 'standard': '', 'top_class': 'remove'}, 
        {'duration': '', 'act': '재우다', 'tool': [], 'ingre': ['고기'], 'seasoning': [], 'volume': [''], 'temperature': [], 'zone': '전처리존', 'start_id': 14, 'end_id': 19, 'sentence': '후 고기양념에 재워주세요.', 'standard': '', 'top_class': 'prepare_ingre'}, 
        {'duration': '', 'act': '넣다', 'tool': ['볼'], 'ingre': [], 'seasoning': ['진간장', '마늘', '설탕', '참기름', '후춧가루'], 'volume': ['2+1/2', '1/2', '1작은술', '2큰술', ''], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 7, 'sentence': '볼에 국수 양념재료를 모두 넣어', 'standard': '', 'top_class': 'put'}, 
        {'duration': '', 'act': '섞다', 'tool': ['주걱'], 'ingre': [], 'seasoning': [], 'volume': [], 'temperature': [], 'zone': '전처리존', 'start_id': 8, 'end_id': 9, 'sentence': '섞어주세요.', 'standard': '', 'top_class': 'mix'}, 
        {'duration': '', 'act': '두르다', 'tool': ['팬'], 'ingre': [], 'seasoning': ['기름'], 'volume': [''], 'temperature': [], 'zone': '화구존', 'start_id': 0, 'end_id': 9, 'sentence': '3. 달군 팬에 약간의 기름을 두르고', 'standard': '', 'top_class': 'put'}, 
        {'duration': '', 'act': '볶다', 'tool': ['주걱'], 'ingre': ['쇠고기'], 'seasoning': [], 'volume': [''], 'temperature': [], 'zone': '화구존', 'start_id': 10, 'end_id': 14, 'sentence': '쇠고기를 볶아주세요.', 'standard': '', 'top_class': 'use_fire'}, 
        {'duration': '', 'act': '넣다', 'tool': [], 'ingre': ['소면'], 'seasoning': [], 'volume': [''], 'temperature': [], 'zone': '화구존', 'start_id': 30, 'end_id': 42, 'sentence': '끓는물에 소면을 펼쳐 넣은', 'standard': '반복해서', 'top_class': 'put'}, 
        {'duration': '', 'act': '젓다', 'tool': ['젓가락'], 'ingre': [], 'seasoning': [], 'volume': [], 'temperature': [], 'zone': '화구존', 'start_id': 30, 'end_id': 42, 'sentence': ' 후 젓가락으로 면끼리 달라붙지 않도록 저어주고', 'standard': '반복해서', 'top_class': 'put'}, 
        {'duration': '', 'act': '붓다', 'tool': [], 'ingre': [], 'seasoning': ['찬물'], 'volume': [''], 'temperature': [], 'zone': '화구존', 'start_id': 30, 'end_id': 42, 'sentence': ', 물이 끓어오르면 찬물 반 컵을 2~3회 반복해서 부어', 'standard': '반복해서', 'top_class': 'put'}, 
        {'duration': '', 'act': '삶다', 'tool': ['냄비'], 'ingre': ['국수'], 'seasoning': [], 'volume': [''], 'temperature': [], 'zone': '화구존', 'start_id': 43, 'end_id': 46, 'sentence': '국수를 삶아주세요.', 'standard': '', 'top_class': 'use_fire'}, 
        {'duration': '', 'act': '씻다', 'tool': [], 'ingre': ['소면'], 'seasoning': [], 'volume': ['200g'], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 8, 'sentence': '흐르는 찬물에 소면을 여러 번 씻어', 'standard': '', 'top_class': 'prepare_ingre'}, 
        {'duration': '', 'act': '물기를 빼다', 'tool': ['체'], 'ingre': [], 'seasoning': [], 'volume': [], 'temperature': [], 'zone': '전처리존', 'start_id': 9, 'end_id': 22, 'sentence': '전분기를 없애고 체에 밭쳐 물기를 빼주세요.', 'standard': '', 'top_class': 'remove'}, 
        {'duration': '', 'act': '넣다', 'tool': ['볼'], 'ingre': ['국수', '쇠고기'], 'seasoning': [], 'volume': ['', ''], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 17, 'sentence': '5. 볼에 삶은 국수와 국수양념재료, 볶은 쇠고기를 넣고', 'standard': '', 'top_class': 'put'}, 
        {'duration': '', 'act': '섞다', 'tool': ['주걱'], 'ingre': [], 'seasoning': [], 'volume': [], 'temperature': [], 'zone': '전처리존', 'start_id': 18, 'end_id': 20, 'sentence': '골고루 섞어주세요.6.', 'standard': '', 'top_class': 'mix'}, 
        {'duration': '', 'act': '담다', 'tool': ['그릇'], 'ingre': [], 'seasoning': ['간장'], 'volume': [''], 'temperature': [], 'zone': '전처리존', 'start_id': 0, 'end_id': 4, 'sentence': '그릇에 간장비빔국수를 담고', 'standard': '', 'top_class': 'put'}, 
        {'duration': '', 'act': '올리다', 'tool': [], 'ingre': ['오이채', '청고추', '어린잎새싹'], 'seasoning': [], 'volume': ['1/2개', '', ''], 'temperature': [], 'zone': '전처리존', 'start_id': 5, 'end_id': 19, 'sentence': '오이채, 청고추, 어린잎새싹을 순서에 맞게 먹음직스럽게 올려담아(올려담아 주세요.7.)', 'standard': '', 'top_class': 'put'}, 
